  ...
  return (
    ...
    >
      <div className="section-container flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-7">
          {LINKS.map((link) => (
            <a
              key={link.href}
              href={link.href}
              className="relative text-cream/90 text-sm font-medium tracking-wide hover:text-gold transition-colors duration-300 after:content-[''] after:absolute after:left-0 after:-bottom-1 after:h-[1.5px] after:w-0 after:bg-gold hover:after:w-full after:transition-all after:duration-300"
            >
              {link.label}
            </a>
          ))}
        ...
        <a href="#contact" className="btn btn-gold hidden lg:inline-flex !py-2.5 !px-5 text-xs">
          Book Free Class
        </a>
      ...
      <AnimatePresence>
        {open && (
          <motion.nav
            ...
            className="lg:hidden overflow-hidden bg-maroon-dark/98 backdrop-blur-md"
          >
